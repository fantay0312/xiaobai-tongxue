...
export const DEMO = {
  ...
  correctedStudentLine:
    '这回我明白了：字数只是表面，真正切成几块要看词表。那“魑魅魍魉”就可能拆得更碎，对吗？',
  needsExampleStudentLine:
    '我还差一步没转过来：到底是什么决定切成几块？老师能拿“今天天气不错”和“魑魅魍魉”比给我看吗？',
