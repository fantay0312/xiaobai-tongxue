...
export const shallowCopyTopic: Topic = {
  ...
  prep: {
    ...
    references: [
      {
        title: 'copy — 浅层及深层拷贝操作(Python 官方文档中文版)',
        url: 'https://docs.python.org/zh-cn/3/library/copy.html',
        kind: '官方文档',
        note:
          '备课的权威底牌:开头三行就把「赋值不复制、浅拷贝复制外层、深拷贝递归复制」讲清,' +
          '重点读「浅层与深层拷贝的区别」那段,小白追问深拷贝行为时照此回答不会翻车。',
      },
      {
        title: 'Python Tutor 代码可视化工具',
        url: 'https://pythontutor.com/',
        kind: '工具',
        note:
          '把 a=[[1,2],3]; b=a.copy(); b[0].append(9) 粘进去逐步执行,箭头图会当场显示 a[0] 和 b[0]' +
          ' 指向同一个子列表——课前自己跑一遍,课上被问倒时截图即是铁证。',
      },
      {
        title: '十分钟!彻底弄懂Python深拷贝与浅拷贝机制(Bilibili)',
        url: 'https://www.bilibili.com/video/BV1jT4y1G7AN/',
        kind: '视频',
        note:
          '12 分钟短视频完整过一遍赋值→浅拷贝→深拷贝的内存机制,适合备课前热身找讲课节奏;' +
          '它演示「改外层不影响、改里层跟着变」的顺序,和你的讲课路线正好一致。',
      },
      {
        title: 'Facts and myths about Python names and values — Ned Batchelder',
